...
declare global {
	namespace JSX {
		...
		type IntriniscHTMLElements = { [K in keyof HTMLElementTagNameMap]: HTMLAttributes<HTMLElementTagNameMap[K]> };
		...
		export interface IntrinsicElements extends IntriniscHTMLElements, IntrinsicSVGElements {}
	}
}
